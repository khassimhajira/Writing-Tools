            ...
            try {
                ...
                if (!$result->isSuccess()) {
                    if ($tr->getErrorCode() == 'E00039') {
                        ...
                        // If interval between two createCustomerProfile  requests is less than 2 minutes Duplicate error will be returned.
...
CUT;
    ...
    public function updateAction()
    {
        ...
        return $this->displayHostedPage($this->getDi()->surl('member', false));
    }
