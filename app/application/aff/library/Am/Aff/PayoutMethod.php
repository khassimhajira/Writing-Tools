...
class Am_Aff_PayoutMethod_Coinpayments extends Am_Aff_PayoutMethod
{
    ...
    public function addFields(Am_CustomFieldsManager $m)
    {
        $_ = ['USDC', 'Ether', 'Litecoin', 'Bitcoin Cash'];
...
class Am_Aff_PayoutMethod_Rise extends Am_Aff_PayoutMethod
{
    public function getTitle()
    {
        return ___("Rise");
    ...
    public function export(AffPayout $payout, Am_Query $details, Am_Mvc_Response $response)
    {
        ...
        $this->sendCsv("rise-commission-" . $payout->payout_id . ".csv", $rows, $response);
    }

    public function addFields(Am_CustomFieldsManager $m)
    {
        $m->add(new Am_CustomFieldText('aff_rise_email',
            ___('Affiliate Payout - Rise Account Email Address'),
            ___('for affiliate commission payouts'), 'email'))
            ->size = 40;
    }
}
