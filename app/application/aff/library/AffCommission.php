...
class AffCommission extends Am_Record
{
    ...
    public function getPayment()
    {
        ...
        return $this->_payment ?: $this->_payment = $this->getDi()->invoicePaymentTable->load($this->invoice_payment_id);
    }
    public function getAff()  { return $this->_aff ?: $this->_aff = $this->getDi()->userTable->load($this->aff_id); }

    public function getInvoice()
    {
        if (empty($this->invoice_id)) return null;
        return $this->_invoice ?: $this->_invoice=$this->getDi()->invoiceTable->load($this->invoice_id);
    }
...
class AffCommissionTable extends Am_Table
{
    ...
    function runPayoutForGroup($date, $days, $groups = null, $excludeGroups = null)
    {
        ...
        ",
            ...
            $this->getDi()->config->get('aff.payout_methods', [-1]),
    ...
    function runPayout($date)
    {
        ...
        ksort($to_check); // handle the lowest first;
