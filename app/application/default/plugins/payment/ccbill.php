...
CUT
    ...
    {
        return $this->getConfig('cancel-discount-offer',  ___("We would like to offer you a $%amount% discount if you decide to stay with our services!"));
    }
...
CUT;
    ...
    function onHourly()
    {
        ...
        foreach ($subaccounts as $subaccount) {
            ...
            //ccBill allow to execute datalink once in an hour only.
