 ...
 */
"use strict";CKEDITOR.plugins.add("placeholder",{requires:"widget,dialog",lang:"af,ar,az,bg,ca,cs,cy,da,de,de-ch,el,en,en-gb,eo,es,es-mx,et,eu,fa,fi,fr,fr-ca,gl,he,hr,hu,id,it,ja,km,ko,ku,lv,nb,nl,no,oc,pl,pt,pt-br,ru,si,sk,sl,sq,sv,th,tr,tt,ug,uk,vi,zh,zh-cn",icons:"placeholder",hidpi:!0,onLoad:function(){CKEDITOR.addCss(".cke_placeholder{background-color:#ff0}")},init:function(e){var a=e.lang.placeholder;CKEDITOR.dialog.add("placeholder",this.path+"dialogs/placeholder.js"),e.widgets.add("placeholder",{dialog:"placeholder",pathName:a.pathName,template:'<span class="cke_placeholder">%%</span>',downcast:function(){return new CKEDITOR.htmlParser.text("%"+this.data.name+"%")},init:function(){this.setData("name",this.element.getText().slice(1,-1))},data:function(){this.element.setText("%"+this.data.name+"%")},getLabel:function(){return this.editor.lang.widget.label.replace(/%1/,this.data.name+" "+this.pathName)}}),e.ui.addButton&&e.ui.addButton("CreatePlaceholder",{label:a.toolbar,command:"placeholder",toolbar:"insert,5",icon:"placeholder"})},afterInit:function(e){var a=/%[^%\s]+%/g;e.dataProcessor.dataFilter.addRules({text:function(l,t){var n=t.parent&&CKEDITOR.dtd[t.parent.name];if(!n||n.span)return l.replace(a,(function(a){var l=new CKEDITOR.htmlParser.element("span",{class:"cke_placeholder"});return l.add(new CKEDITOR.htmlParser.text(a)),e.widgets.wrapElement(l,"placeholder").getOuterHtml()}))}})}}),
/**
 * @license Copyright (c) 2003-2017, CKSource - Frederico Knabben. All rights reserved.
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
 ...
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
CKEDITOR.plugins.setLang("placeholder","es-mx",{title:"Propiedades del marcador de posición",toolbar:"Marcador de posición",name:"Nombre del marcador de posición",invalidName:"El marcador de posición no puede estar vacío y no puede contener alguno de los siguientes caracteres: [, ], <, >",pathName:"marcador de posición"}),
/**
 * @license Copyright (c) 2003-2017, CKSource - Frederico Knabben. All rights reserved.
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
 ...
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
CKEDITOR.plugins.setLang("placeholder","fr",{title:"Propriétés de l'espace réservé",toolbar:"Espace réservé",name:"Nom de l'espace réservé",invalidName:"L'espace réservé ne peut pas être vide ni contenir l'un de ces caractères : [, ], <, >",pathName:"espace réservé"}),
/**
 * @license Copyright (c) 2003-2017, CKSource - Frederico Knabben. All rights reserved.
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
 ...
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
CKEDITOR.plugins.setLang("placeholder","pt",{title:"Propriedades dos marcadores",toolbar:"Marcador",name:"Nome do marcador",invalidName:"O marcador não pode estar em branco e não pode conter qualquer dos seguintes carateres: [, ], <, >",pathName:"marcador"}),
/**
 * @license Copyright (c) 2003-2017, CKSource - Frederico Knabben. All rights reserved.
 * For licensing, see LICENSE.md or http://ckeditor.com/license
 */
