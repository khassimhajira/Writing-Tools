...
first and last name',
  ...
  'Activate Delayed Payments Immediately
            ...
            once it gets payment processing notification from Stripe' => 'Activate Delayed Payments Immediately
...
whenever coupons from this batch is used, commission will always be credited to this affiliate. This is true even when another affiliate is permanently tagged to the customer. For sales where the coupon is NOT used, the original (previous) affiliate will continue receiving commissions. If the customer has no affiliate, this affiliate will permanently be tagged to the customer, and will receive credit for future sales.',
  ...
  'Affiliate Commissions By Product' => 'Affiliate Commissions By Product',
...
By default instant commissions will be enabled only if you enable this in affiliate profile',
  ...
  'Allow for customer to change item quantity' => 'Allow for customer to change item quantity',
...
such as fixed land line, mobile, VoIP, and invalid phone numbers',
  ...
  'Amount received is not correct. Expected %s, got %s' => 'Amount received is not correct. Expected %s, got %s',
...
You can choose same admin several times to balance tickets accordingly',
  ...
  'Cities
keep empty to report all' => 'Cities
...
(Optional)',
  ...
  'Commission By Product' => 'Commission By Product',
...
please select one',
  ...
  'Credits Balance %s %d' => 'Credits Balance %s %d',
  'Credits Price
...
populate coupon field with default value within this date range' => 'Default Coupon Dates
...
aMember will require two peices of location evidence before an invoice is created. Invoice that fails validation will be blocked and user will receive warning.' => 'Enable Location Validation
aMember will require two peices of location evidence before an invoice is created. Invoice that fails validation will be blocked and user will receive warning.',
...
keep empty to report all files',
  ...
  'Files located on MojoCloud Object Storage storage. (Warning: Your buckets should not contain letters in uppercase in its name)' => 'Files located on MojoCloud Object Storage storage. (Warning: Your buckets should not contain letters in uppercase in its name)',
...
in case of empty all active users will be included',
  ...
  'Incorrect environment' => 'Incorrect environment',
...
This text will be included at bottom to PDF Invoice. You can use all user specific placeholders here eg. %user.login%, %user.name_f%, %user.name_l% etc.',
  ...
  'Invoice ID is missing in request' => 'Invoice ID is missing in request',
  ...
  'Invoice Started after %s' => 'Invoice Started after %s',
  'Invoice Started before %s' => 'Invoice Started before %s',
  'Invoice Started between %s and %s' => 'Invoice Started between %s and %s',
  'Invoice Status' => 'Invoice Status',
  'Invoice Summary' => 'Invoice Summary',
  'Invoice Terms' => 'Invoice Terms',
  'Invoice Text' => 'Invoice Text',
  'Invoice Upgrades' => 'Invoice Upgrades',
  'Invoice created for another user' => 'Invoice created for another user',
...
It will be used for SMS notifications',
  ...
  'MojoCloud Object Storage storage is not configured' => 'MojoCloud Object Storage storage is not configured',
  'Month' => 'Month',
...
you can choose new password here or keep it unchanged
must be %d or more characters',
  'New Password should be different than your current one' => 'New Password should be different than your current one',
...
Enable %sTelephone Number Identification (TNI)%s service',
  ...
  'Number of Payments by Billing Plan' => 'Number of Payments by Billing Plan',
...
you can enter any HTML here, it will be displayed to customer when he chooses to pay using this payment system you can use the following tags: %s - Receipt HTML, %s - Invoice Title, %s - Invoice Id, %s - Invoice Total, %s - Consumer Number/Voucher Code',
  'Payment Intent is empty in request' => 'Payment Intent is empty in request',
...
keep empty to report all',
  ...
  'Payment was disputed and a chargeback was received. User account disabled.' => 'Payment was disputed and a chargeback was received. User account disabled.',
  'Payments' => 'Payments',
  ...
  'Payments by Customer City' => 'Payments by Customer City',
...
you still can signup again as new user.',
  ...
  'Please use this link to complete your subscription payment manually: %s' => 'Please use this link to complete your subscription payment manually: %s',
...
leave empty to reset for all users',
  ...
  'Retry On Failure
if the recurring billing has failed, aMember can repeat it after several days, and extend customer subscription for that period. Enter number of days to repeat billing attempt, numbers which is more than billing cycle is ignored' => 'Retry On Failure
if the recurring billing has failed, aMember can repeat it after several days, and extend customer subscription for that period. Enter number of days to repeat billing attempt, numbers which is more than billing cycle is ignored',
  'Return' => 'Return',
...
available in the member area for customers',
  ...
  'Set MAC' => 'Set MAC',
  'Set Product Picture' => 'Set Product Picture',
  'Set Successfully' => 'Set Successfully',
  'Set roles: %s' => 'Set roles: %s',
  'Settings' => 'Settings',
  'Settings saved successfully' => 'Settings saved successfully',
  'Setup Intent is empty in request' => 'Setup Intent is empty in request',
...
for recurring subscription aMember notify iDevAffiliate only about initial payment',
  ...
  'Transaction is not paid' => 'Transaction is not paid',
...
if user has paid subscirption to a channel',
  ...
  'Unable to contact encryption service: %s' => 'Unable to contact encryption service: %s',
  ...
  'Unique Clicks/All Clicks/Sales' => 'Unique Clicks/All Clicks/Sales',
...
by default only tier 0 is used' => 'Use Commission for all tiers to rank affiliates
by default only tier 0 is used',
...
notify the following admins about new messages in this ticket',
  ...
  'We would like to offer you a $%amount% discount if you decide to stay with our services!' => 'We would like to offer you a $%amount% discount if you decide to stay with our services!',
...
(not to be confused with the Control Panel username)',
  ...
  'You have not any payments associated with cities yet.' => 'You have not any payments associated with cities yet.',
