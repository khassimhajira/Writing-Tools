...
Default value is 1 one hour)',
  ...
  'Active Registrations (Not pending)' => 'Active Registrations (Not pending)',
  'Actual' => 'Actual',
...
allow use coupons on shopping cart checkout page',
  ...
  'Enter valid email address to send test message' => 'Enter valid email address to send test message',
  'Error Log' => 'Error Log',
...
redirect all request to https',
  ...
  'Full' => 'Full',
  'Full Name (First and Last)' => 'Full Name (First and Last)',
  'Future' => 'Future',
  'General' => 'General',
...
How many simultaneous bindings for license may exists (default - 1)',
  ...
  'Invoice Started' => 'Invoice Started',
...
* subscription expiration notices',
  ...
  'Last Paid Users List' => 'Last Paid Users List',
...
used to represent product in Active Subscriptions widget on user dashboard, leave empty to display product without link. This link will not become automatically protected.',
  ...
  'Manually Reverse (Reverse Sort Order in Admin Interface)' => 'Manually Reverse (Reverse Sort Order in Admin Interface)',
...
leave empty if you want to redirect to default \'No access\' page',
  ...
  'Note' => 'Note',
  'Notify About Permanently Failed Webhooks' => 'Notify About Permanently Failed Webhooks',
...
apply only to active recurring subscriptions' => 'Only Active Recurring
...
you can create new pages %shere%s',
  ...
  'Paid' => 'Paid',
  'Paid Registrations' => 'Paid Registrations',
  'Paid Registrations (User with at least one payment)' => 'Paid Registrations (User with at least one payment)',
  'Params' => 'Params',
  'Parent' => 'Parent',
...
applicable only for video files',
  ...
  'Private Key Path
path where you have uploaded your private.key including file name' => 'Private Key Path
path where you have uploaded your private.key including file name',
...
coupons can be used with selected products only. if nothing selected, coupon can be used with any product',
  ...
  'Public Key Path
path where you have uploaded your public.key including file name' => 'Public Key Path
path where you have uploaded your public.key including file name',
...
Default value is 30 days',
  ...
  'Remove It From Catalogue Even if Condition can be met in Current Purchase' => 'Remove It From Catalogue Even if Condition can be met in Current Purchase',
...
Email and Groups fields is always enabled',
  ...
  'Retrieve Access Parameters if necessary' => 'Retrieve Access Parameters if necessary',
  'Retrying' => 'Retrying',
...
Press [Skip] to type it manually from scratch.',
  'This field is required for chosen action' => 'This field is required for chosen action',
...
audio formats that supported by HTML5',
  ...
  'Voided' => 'Voided',
  'WARNING! ALL YOUR CURRENT AMEMBER TABLES AND RECORDS WILL BE REPLACED WITH THE CONTENTS OF THE BACKUP!' => 'WARNING! ALL YOUR CURRENT AMEMBER TABLES AND RECORDS WILL BE REPLACED WITH THE CONTENTS OF THE BACKUP!',
...
notify the following admins about new messages in this category',
  ...
  'Weekly' => 'Weekly',
  'What is denied reason?' => 'What is denied reason?',
...
and template filename must start with [signup]',
  ...
  'change over same period in previous year (YoY)' => 'change over same period in previous year (YoY)',
