...
class Am_Event
{
    ...
    /** Ability to do additional checks on user before send restore password link */
    const AUTH_LOST_PASS_USER_CHECK = 'authLostPassUserCheck';
    ...
    const AUTH_CONTROLLER_SHOW_RECAPTCHA = 'authControllerShowRecaptcha';
    /**
    ...
    /**
     * Called after invoice cancellation
     * <li>{@link Invoice} invoice</li>
     */
    const INVOICE_AFTER_CANCEL = 'invoiceAfterCancel';
    /**
     * Called after invoice restart
     * <li>{@link Invoice} invoice</li>
     */
    const INVOICE_AFTER_RESTART = 'invoiceAfterRestart';
    /**
     * Called after recurring invoice failed
     * <li>{@link Invoice} invoice</li>
     */
    const INVOICE_AFTER_FAILED = 'invoiceAfterFailed';
    /**
    ...
    const USER_ALL_MENU = 'userAllMenu';
    ...
    const GET_GLOBAL_BASE_TRANSLATION_DATA = 'getGlobalBaseTranslationData';
    /**
    ...
    /**
     * Get list of emailing methods
     * use addReturn() to add new methods to the list
     */
    const GET_EMAILING_METHODS = 'getEmailingMethods';

    /**
     * add input elements to Emailing Methods section
     *
     * @param HTML_QuickForm2_Container_Fieldset $fieldset
     */
    const EMAILING_METHODS_INIT_FORM = 'emailingMethodsInitForm';
