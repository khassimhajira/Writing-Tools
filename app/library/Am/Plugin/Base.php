...
class Am_Plugin_Base implements \Psr\Log\LoggerAwareInterface
{
    ...
    const STATUS_DEV = 4; // development - do not include into distributive
     ...
     */
    protected $hooksToAlwaysEnable = ['setupForms', 'adminWarnings', 'setupEmailTemplateTypes', 'emailTemplateTagSets'];
