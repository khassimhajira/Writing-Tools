...
class Am_Mvc_Router_Route extends Am_Mvc_Router_Route_Abstract
{
     ...
     */
    public function __construct($route, $defaults = [], $reqs = [], $translator = null, $locale = null)
    {
        ...
        foreach ($this->_parts as $key => $part) {
            ...
            if (isset($name)) {
                if (isset($data[$name]) && !$useDefault) {
                    ...
                    throw new Am_Mvc_Router_Exception($name . ' is not specified');
                }
