...
class Am_Period
{
    ...
    function fromString($string)
    {
        ...
        } elseif (preg_match($regex='/^(\d+)\s*(|w|'.join('|', [self::DAY, self::MONTH, self::YEAR]).')$/', $string, $regs)) {
    ...
    function isLifetime(): bool
    {
        return $this->count == self::MAX_SQL_DATE;
    }

    function isFixed(): bool
    {
     ...
     */
    static function getLifetime(): Am_Period
    {
