 ...
 *
 * @category   Zend
 * @package    Am_Navigation_Container
 * @subpackage Page
...
/**
 * @see Am_Navigation_Page
 */
//--//require_once 'Zend/Navigation/Page.php';

/**
 * @see Am_Controller_Action_HelperBroker
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Am_Navigation_Page_Mvc extends Am_Navigation_Page
{
    /**
     ...
     *
     * @see getHref()
     * @var Am_Controller_Action_Helper_Url
     */
    ...
    public function isActive($recursive = false)
    {
        ...
        if (null === $this->_active) {
            ...
            if ($this->_route
                && method_exists($di->router, 'getRoute')
            ) {
                $route = $di->router->getRoute($this->_route);
     ...
     *
     * This method uses {@link Am_Controller_Action_Helper_Url} to assemble
    ...
    public function getHref()
    {
        ...
        if (null === self::$_urlHelper) {
            self::$_urlHelper = new Am_Mvc_Helper_Url();
        }
...
//                self::$_schemeHelper = new Am_View_Helper_ServerUrl();
//            }
//
...
//        }
     ...
     * @return Am_Navigation_Page_Mvc   fluent interface, returns self
     * @throws Am_Navigation_Exception  if invalid $action is given
     */
     ...
     * @return Am_Navigation_Page_Mvc   fluent interface, returns self
     * @throws Am_Navigation_Exception  if invalid controller name is given
     */
     ...
     * @return Am_Navigation_Page_Mvc   fluent interface, returns self
     * @throws Am_Navigation_Exception  if invalid module name is given
     */
     ...
     * @return Am_Navigation_Page_Mvc   fluent interface, returns self
     * @throws Am_Navigation_Exception  if invalid $route is given
     */
     ...
     * @throws Am_Navigation_Exception
     * @return Am_Navigation_Page_Mvc   fluent interface, returns self
     */
     ...
     * @see getHref()
     *
     * @param  Am_Controller_Action_Helper_Url $uh  URL helper
     * @return void
     */
    public static function setUrlHelper(Am_Controller_Action_Helper_Url $uh)
    {
        self::$_urlHelper = $uh;
    }
     ...
     * @see getHref()
     *
     * @param  Am_View_Helper_ServerUrl $sh   scheme helper
     * @return void
     */
    public static function setSchemeHelper(Am_View_Helper_ServerUrl $sh)
    {
