...
class InvoicePayment extends Am_Record_WithData
{
    ...
    public function insert($reload = true)
    {
        ...
        $this->is_first = ($invoice->first_total == 0 || $invoice->getPaymentsCount() > 0) ? 0 : 1;
    ...
    {
        parent::delete();
        $this->getDi()->hook->call(Am_Event::PAYMENT_AFTER_DELETE, ['payment' => $this]);
        return $this;
    }
    ...
    public function _setInvoice(Invoice $invoice): self
    {
    ...
    /**
     * Set Invoice ID which will be displayed in pdf invoice
     */
...
class InvoicePaymentTable extends Am_Table_WithData
{
    ...
    {
        ///// NEED REAL ATTENTION HERE: Added to handle imported payments correctly.
