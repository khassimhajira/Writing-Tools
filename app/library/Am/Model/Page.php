...
class Page extends ResourceAbstract
{
    ...
    {
        return $this->path
            ? $this->getDi()->url("page/" . urlencode($this->path), false)
            : $this->getDi()->url("content/p/id/$this->page_id/", false);
    }
    ...
    public function render(Am_View $view, $user = null, $use_layout = true)
    {
        ...
        $e = new Am_Event_PageBeforeRender(Am_Event::PAGE_BEFORE_RENDER, [
            'template' => $t,
            'user' => $user,
            'page' => $this,
            'html' => $html,
        ...
        if ($use_layout && $this->use_layout) {
            ...
            $view->meta_title = ___($this->meta_title ?: $this->title);
            ...
            return $view->render($this->tpl ?: (is_bool($use_layout) ? 'layout.phtml' : $use_layout));
        } else {
            return $html;
        }
    }
