...
class Am_SimpleTemplate
{
    ...
    static $modifiers = [
        ...
        'sha256' => ['Am_SimpleTemplate', 'sha256'],
        'default' => ['Am_SimpleTemplate', '_default'],
        'label' => ['Am_SimpleTemplate', '_label'],
        'paysys_title' => ['Am_SimpleTemplate', '_paysys_title'],
        'nl2br' => 'nl2br',
    ...
    static function _paysys_title($v)
    {
        $op = Am_Di::getInstance()->paysystemList->getOptions();
        return $op[$v] ?? $v;
    }
    ...
    function render($text)
    {
        ...
        $text = preg_replace_callback("#%('[.:/a-zA-Z+-][.:/a-zA-Z0-9_+-]*')(?:\.([a-zA-Z0-9_]+))?(\|[a-zA-Z0-9_: |]+)?%#", [$this, '_replace'], $text);
