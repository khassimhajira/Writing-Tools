 ...
 */
abstract class Am_View_Helper_NavigationAbstract
    extends Zend_View_Helper_Abstract
{
     ...
     *
     * @var string|Am_Acl_Role_Interface
     */
    protected $_role;
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Interface::setContainer()}.
     *
     * @param  Am_Navigation_Container $container        [optional] container
     *                                                     to operate on.
     *                                                     Default is null,
     *                                                     meaning container
     *                                                     will be reset.
     ...
     *                                                     returns self
     */
    public function setContainer(?Am_Navigation_Container $container = null)
    {
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Interface::getContainer()}.
     *
     * If no container is set, and nothing is found in Am_Registry, a new
     * container will be instantiated and stored in the helper.
     *
     * @return Am_Navigation_Container  navigation container
     */
     ...
     *                                              is true.
     *
     * @return Am_View_Helper_Navigation_Sitemap  fluent interface, returns
     *                                              self
     */
     ...
     * @return  Am_View_Helper_Navigation_HelperAbstract  fluent interface, returns self
     */
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::setTranslator()}.
     *
     * @param  mixed $translator                           [optional] translator.
     *                                                     Expects an object of
     *                                                     type
     *                                                     {@link Am_Translate_Adapter}
     *                                                     or {@link Am_Translate},
     *                                                     or null. Default is
     *                                                     null, which sets no
     *                                                     translator.
     * @return Am_View_Helper_Navigation_HelperAbstract  fluent interface,
    ...
    {
        if (null == $translator ||
            $translator instanceof Am_Translate_Adapter) {
            $this->_translator = $translator;
        } elseif ($translator instanceof Am_Translate) {
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::getTranslator()}.
     *
     * @return Am_Translate_Adapter|null  translator or null
     */
    public function getTranslator()
    {
        if (null === $this->_translator) {
            //--//require_once 'Am_/Registry.php';
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::setAcl()}.
     *
     * @param  Am_Acl $acl                               [optional] ACL object.
     *                                                     Default is null.
     * @return Am_View_Helper_Navigation_HelperAbstract  fluent interface,
     *                                                     returns self
     */
    public function setAcl(?Am_Acl $acl = null)
    {
        $this->_acl = $acl;
        return $this;
    }
     ...
     * {@link setDefaultAcl()}
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::getAcl()}.
     *
     * @return Am_Acl|null  ACL object or null
     */
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::setRole()}.
     *
     * @param  mixed $role                                 [optional] role to
     *                                                     set. Expects a string,
     *                                                     an instance of type
     *                                                     {@link Am_Acl_Role_Interface},
     *                                                     or null. Default is
     *                                                     null, which will set
     *                                                     no role.
     * @throws Am_View_Exception                         if $role is invalid
     * @return Am_View_Helper_Navigation_HelperAbstract  fluent interface,
     *                                                     returns self
     */
    public function setRole($role = null)
    {
        if (null === $role || is_string($role) ||
            $role instanceof Am_Acl_Role_Interface) {
            $this->_role = $role;
        } else {
            //--//require_once 'Am_/View/Exception.php';
            $e = new Am_View_Exception(sprintf(
                '$role must be a string, null, or an instance of '
                .  'Am_Acl_Role_Interface; %s given',
                gettype($role)
            ));
            $e->setView($this->view);
            throw $e;
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::getRole()}.
     *
     * @return string|Am_Acl_Role_Interface|null  role or null
     */
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::setUseAcl()}.
     *
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::getUseAcl()}.
     *
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::setUseTranslator()}.
     *
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::getUseTranslator()}.
     *
...
//     * @throws Am_Navigation_Exception  if method does not exist in container
//     */
...
//     *
//     * Implements {@link Am_View_Helper_Navigation_Helper::__toString()}.
//     *
//     * @return string
//     */
...
//    }
     ...
     *
     * @param  Am_Navigation_Container $container  container to search
     ...
     *                                               if not found
     */
    public function findActive(Am_Navigation_Container $container,
                               $minDepth = null,
                               $maxDepth = -1)
    {
        if (!is_int($minDepth)) {
        ...
        if (is_int($maxDepth) && $foundDepth > $maxDepth) {
            while ($foundDepth > $maxDepth) {
                ...
                if (!$found instanceof Am_Navigation_Page) {
                    $found = null;
                    break;
                }
            }
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::hasContainer()}.
     *
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::hasAcl()}.
     *
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::hasRole()}.
     *
     ...
     *
     * Implements {@link Am_View_Helper_Navigation_Helper::hasTranslator()}.
     *
     ...
     *
     * @param  Am_Navigation_Page $page      page to check
     ...
     */
    public function accept(Am_Navigation_Page $page, $recursive = true)
    {
        // accept by default
        $accept = true;
        ...
        if ($accept && $recursive) {
            ...
            if ($parent instanceof Am_Navigation_Page) {
     ...
     */
    protected function _acceptAcl(Am_Navigation_Page $page)
    {
        if (!$acl = $this->getAcl()) {
     ...
     *
     * Overloads {@link Am_View_Helper_HtmlElement::_htmlAttribs()}.
     *
     ...
     * Normalize an ID
     *
     * Extends {@link Am_View_Helper_HtmlElement::_normalizeId()}.
     *
     ...
     *
     * @param  Am_Acl $acl  [optional] ACL object. Default is null, which
     *                        sets no ACL object.
     * @return void
     */
    public static function setDefaultAcl(?Am_Acl $acl = null)
    {
    ...
    public static function setDefaultRole($role = null)
    {
        if (null === $role ||
            ...
            //--//require_once 'Am_/View/Exception.php';
            throw new Am_View_Exception(
                '$role must be null|string|Am_Acl_Role_Interface'
            );
        }
    }
}
