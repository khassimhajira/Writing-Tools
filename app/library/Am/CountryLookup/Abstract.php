...
abstract class Am_CountryLookup_Abstract
{
    /**
    ...
    public function getCountryCodeByIp($ip)
    {
        ...
        return Am_Di::getInstance()->cacheFunction->call([$this, '_getCountry'], [$ip],
            ['id' => __CLASS__ . __FUNCTION__ . md5($ip)], 2592000); // 30 days
    }

    abstract public function _getCountry($ip);
